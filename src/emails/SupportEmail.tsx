// src/emails/SupportEmail.tsx
import * as React from 'react';
import { 
  Html, Body, Head, Heading, Text, Container, 
  Preview, Section, Hr, Img, Link
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Heading style={{
            ...
            margin: '30px 0',
            padding: '0',
          }}>New Support Request</Heading>
          
          <Section style={section}>
            <Text style={fieldLabel}>From:</Text>
            <Text style={fieldValue}>{name} ({email})</Text>
          ...
          <Section style={{
            ...
            <Text style={footerText}>
              This email was sent from the NoVerif support form.
            </Text>
            <Text style={footerText}>
